...
<html>
    <head>
		<!-- Meta tags -->
		<meta charset="UTF-8">
		<title><?php echo $site_name;?> | Управление серверами</title>
			   ...
			   <form action="" method="POST" style="margin: 0 0 5px;">
					<div class="modal-body">
						<div class="alert alert-success" style="margin-bottom: 0;">
							...
							<input style="float:right; margin-right: 20px;" class="btn btn-success" type="submit" value="Да" name="update">  
						</div>
					</div>
				</form>
			</div><!-- /.modal-dialog -->
			   ...
			   <form action="" method="POST" style="margin: 0 0 5px;">
					<div class="modal-body">
						<div class="alert alert-success" style="margin-bottom: 0;">
							...
							<a class="btn btn-danger" data-dismiss="modal">Нет</a>
							<input style="float:right; margin-right: 20px;" class="btn btn-success" type="submit" value="Да" name="del_chat">  
						</div>
					</div>
				</form>
			</div><!-- /.modal-dialog -->
			   ...
			   <form action="" method="POST" style="margin: 0 0 5px;">
					<div class="modal-body">
						<div class="alert alert-success" style="margin-bottom: 0;">
							...
							<a class="btn btn-danger" data-dismiss="modal">Нет</a>
							<input style="float:right; margin-right: 20px;" class="btn btn-success" type="submit" value="Да" name="opt">  
						</div>
					</div>
				</form>
			</div><!-- /.modal-dialog -->
